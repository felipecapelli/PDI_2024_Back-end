...
namespace SalesSystemPDI2024.Data.DAL
{
    public class ShipmentDAL
    {
        public long GetLastID()
        {
            ...
            string sql = "SELECT IDENT_CURRENT('[SalesSystemPDI2024].[dbo].[Shipments]') AS ID";
        ...
        public IEnumerable<Shipment> List()
        {
            ...
            string sql = "SELECT * FROM [SalesSystemPDI2024].[dbo].[Shipments] ORDER BY ShipmentID DESC";
            SqlCommand command = new SqlCommand(sql, connection);
            using SqlDataReader dataReader = command.ExecuteReader();
