...
namespace SalesSystemPDI2024.Data.DAL
{
    public class VariableUnitOfMeasurementDAL
    {
        public long GetLastID()
        {
            ...
            string sql = "SELECT IDENT_CURRENT('[SalesSystemPDI2024].[dbo].[VariableUnitsOfMeasurement]') AS ID";
        ...
        public IEnumerable<VariableUnitOfMeasurement> List()
        {
            ...
            string sql = "SELECT * FROM [SalesSystemPDI2024].[dbo].[VariableUnitsOfMeasurement] ORDER BY VariableUnitOfMeasurementID DESC";
            SqlCommand command = new SqlCommand(sql, connection);
            using SqlDataReader dataReader = command.ExecuteReader();
