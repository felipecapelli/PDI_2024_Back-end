...
namespace SalesSystemPDI2024.Data.DAL
{
    public class BaseUnitOfMeasurementDAL
    {
        public long GetLastID()
        {
            ...
            string sql = "SELECT IDENT_CURRENT('[SalesSystemPDI2024].[dbo].[BaseUnitsOfMeasurement]') AS ID";
        ...
        public IEnumerable<BaseUnitOfMeasurement> List()
        {
            ...
            string sql = "SELECT * FROM [SalesSystemPDI2024].[dbo].[BaseUnitsOfMeasurement] ORDER BY BaseUnitOfMeasurementID DESC";
            SqlCommand command = new SqlCommand(sql, connection);
            using SqlDataReader dataReader = command.ExecuteReader();
