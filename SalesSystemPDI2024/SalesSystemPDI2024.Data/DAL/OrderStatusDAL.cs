...
namespace SalesSystemPDI2024.Data.DAL
{
    public class OrderStatusDAL
    {
        public long GetLastID()
        {
            ...
            string sql = "SELECT IDENT_CURRENT('[SalesSystemPDI2024].[dbo].[OrderStatuses]') AS ID";
        ...
        public IEnumerable<OrderStatus> List()
        {
            ...
            string sql = "SELECT * FROM [SalesSystemPDI2024].[dbo].[OrderStatuses] ORDER BY StatusID DESC";
            SqlCommand command = new SqlCommand(sql, connection);
            using SqlDataReader dataReader = command.ExecuteReader();
